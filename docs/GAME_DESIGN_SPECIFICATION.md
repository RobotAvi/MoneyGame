...
- **Цель**: Достичь финансовой независимости (когда пассивный доход ≥ расходы)
- **Механика**: Пошаговая игра с бросанием кубика, покупкой активов и управлением финансами; время моделируется календарём (дни/месяцы)
...
- **Кнопки действий** (внизу экрана):
  ...
  - "Финансовый журнал" и "Аналитика" (активны после первого события)
...
- Инженер (130,000₽/мес)
- Врач (150,000₽/мес)
- Менеджер (115,000₽/мес)
- Механик (90,000₽/мес)
- Юрист (160,000₽/мес)

**3. Мечты:**
- Собственная яхта (15,000,000₽)
- Ресторан (12,000,000₽)
- Благотворительность (5,000,000₽)
- Частный остров (50,000,000₽)
- Космический туризм (30,000,000₽)
- Бизнес-империя (100,000,000₽)
...
**1. Движение по времени:**
- Бросок кубика (1-6) = продвижение по дням календарного месяца
- Переход на 1-е число месяца начисляет зарплату
- Ежемесячные операции: расходы, кредиты, пассивный доход, сбережения
...
### Финансовый журнал и аналитика:
- Хронология всех операций
- Статистика по категориям доходов и расходов
- Экспорт в TXT и возможность поделиться
- Поиск по описанию
- Экспорт данных
